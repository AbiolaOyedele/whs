...
sections:
  - title: 'The problem'
    body: 'Ideas turn up while you are walking, driving or between meetings. A voice memo captures the thought and then buries it — raw, untitled, unsearchable, and needing exactly the cleanup work you did not have time for in the first place.'
  - title: 'What we built'
